...
{
    QString help;
    help.append("<p>Apply a regular expression to the input (UTF8)</p><p>Two main modes: <ul><li>Search & Extract = to extract strings</li><li>Search & Replace = to replace string portions</li></ul></p><p>There are lots of fine grain configurations</p>");
    return help;
}
